...
function Adduser() {
  ...
  const submitData = async (e) => { 
    ...
    if ( validateForm()) {
      ...
      console.log("success");
        try {
          await axios.post(baseURL+'/create', details,{
          headers: {
          ...
          .then((response)=>{console.log(response.data,)
            ...
            alert("Hii Admin, The Account is successfully created  ")
            navigate("/userlist");

            })
          .catch(error=>{console.log('error:' ,error,alert("The username or E-mail is already in use please use another one /"))
        });
